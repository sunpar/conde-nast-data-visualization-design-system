...
module.exports = {
  plugins: [
    ...
    */
    ...
    /* 
      PostCSS plugin to generate all @font-face rules
    */
        ...
        Rubik: {
          variants: {
            normal: {
              300: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-Light.ttf"
                }
              },
              400: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-Regular.ttf"
                }
              },
              500: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-Medium.ttf"
                }
              },
              600: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-Bold.ttf"
                }
              }
            },
            italic: {
              300: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-LightItalic.ttf"
                }
              },
              400: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-Italic.ttf"
                }
              },
              500: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-MediumItalic.ttf"
                }
              },
              600: {
                url: {
                  ttf: "../Assets/Fonts/Rubik-BoldItalic.ttf"
                }
              }
            }
          }
